...
def info_snatcher(path, info_name, cat_row, search_row):
    wb_on_hand = xl.load_workbook(path)
    ws_on_hand = wb_on_hand.active
...
if __name__ == "__main__":
    ...
    test_cat_row = 2
    test_search_row = 6
    print(info_snatcher(test_path, test_info_name, test_cat_row, test_search_row))
